...
The function is written using pointwise division of the numerator and
denominator functions, exactly matching Lean's quotient-rule interface; this
is extensionally the map `q ↦ L_q(a) / M_q(a)`.
